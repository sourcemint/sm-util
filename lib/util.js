...
// @credit https://github.com/nrf110/deepmerge/blob/702e24a50aa62d7835c4a357e8a74e1aa5ac8856/index.js
exports.deepMergeReplaceArrays = function(target, src) {
    var dst = {};
        ...
        Object.keys(src).forEach(function (key) {
            if (typeof src[key] !== 'object' || !src[key]) {
                ...
                if (!target[key]) {
                    ...
                    dst[key] = exports.deepMergeReplaceArrays(target[key], src[key]);
                }
            }
        })
    }
